...
public class ShowItemActivity extends AppCompatActivity implements Callback<Comments> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //设置内容显示部分
        LinearLayout linearLayout = (LinearLayout) findViewById(R.id.showItem_linearLayout);
        ImageView icon = (ImageView) findViewById(R.id.showItem_text_icon);
        TextView name = (TextView) findViewById(R.id.showItem_text_name);
        TextView type = (TextView) findViewById(R.id.showItem_text_type);
        TextView content = (TextView) findViewById(R.id.showItem_text_content);
        TextView downUp = (TextView) findViewById(R.id.showItem_text_downUp);
        TextView comments = (TextView) findViewById(R.id.showItem_text_comments);
        TextView share = (TextView) findViewById(R.id.showItem_text_share);
        ImageView image = (ImageView) findViewById(R.id.showItem_text_image);
        ImageView videoImage = (ImageView) findViewById(R.id.showItem_text_videoImage);
        ImageView videoPlay = (ImageView) findViewById(R.id.showItem_text_videoPlay);
        ImageView typeImage = (ImageView) findViewById(R.id.showItem_text_typeImage);
        ...
        TextItem.ItemsEntity itemsEntity = (TextItem.ItemsEntity) intent.getSerializableExtra("TextItem");
            ...
            if (itemsEntity.getImage() == null) {
                ...
                Picasso.with(this)
                        ...
                        .resize(linearLayout.getWidth(),0)
